 ...
 * Based on provided code using Three.js and custom shaders
 */
...
class LiquidBackground {
  ...
  init() {
    if (document.getElementById('webGLApp')) return;
    ...
    Object.assign(this.renderer.domElement.style, {
      ...
      height: '100%',
      zIndex: '0', // Base layer
      pointerEvents: 'none' // Let clicks pass through if needed, but we capture mousemove globally
    });
    ...
    this.scene.background = new THREE.Color(0x0a0e27); // Navy base
